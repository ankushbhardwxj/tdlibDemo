 ...
 */
export declare type editInlineMessageLiveLocation = (params?: EditInlineMessageLiveLocationParams, options?: ApiRequestOptions) => Promise<ApiResponse<EditInlineMessageLiveLocationParams, OkUnion>>;

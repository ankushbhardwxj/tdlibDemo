 ...
 */
export declare type sendPassportAuthorizationForm = (params?: SendPassportAuthorizationFormParams, options?: ApiRequestOptions) => Promise<ApiResponse<SendPassportAuthorizationFormParams, OkUnion>>;
